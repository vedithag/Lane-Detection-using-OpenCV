...
This script contains functions for image processing tasks such as
binary thresholding, Gaussian blurring, Sobel edge detection, and
applying thresholds to image channels. These functions are designed
to preprocess images before further analysis, such as lane detection.
